...
class Triangle():
	def __init__(self, screen, SCREEN_WIDTH, SCREEN_HEIGHT):
		self.right = [SCREEN_WIDTH * 5/6, SCREEN_HEIGHT * 5/6,
		SCREEN_WIDTH * 0.5, SCREEN_HEIGHT * 1/6]
...
class Model():
	...
	def draw_og_tri(self, screen, SCREEN_WIDTH, SCREEN_HEIGHT):
		...
		self.draw_triangles(screen, SCREEN_WIDTH, SCREEN_HEIGHT)
	...
	def draw_triangles(self, screen, SCREEN_WIDTH, SCREEN_HEIGHT):
		#draw bot
